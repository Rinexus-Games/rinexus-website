...
function BugReportRedirect() {
  React.useEffect(() => {
    window.location.href = 'https://forms.gle/pa1wvnTDZcLWw6bS7';
  }, []);
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <p className="text-lg">Redirecting to the bug report form...</p>
    </div>
  );
}
                  ...
                  <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row">
                    ...
                    <div className="md:w-2/3 p-6">
                      <p className="text-lg mb-4">
                        <b>Rinexus Games</b> is a one-man indie game development studio based in the
                        Philippines.
                      </p>
                      <p className="text-lg mb-4">
                        Known for games like <b>Stranded on a Raft</b> and <b>Pisonet Simulator</b>,
                        our goal is to create unique and engaging experiences for players worldwide.
                      </p>
